...
public class SignUpController {
	...
	@RequestMapping(path = "/signup", method = RequestMethod.POST, produces = { MediaType.APPLICATION_JSON_UTF8_VALUE,
	...
	@RequestMapping(value = "/signup/check-id/{id}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/signup/check-email", method = RequestMethod.POST)
	...
	@RequestMapping(path = "signup/check-nickname/{nickname}", method = RequestMethod.GET)
