...
public class ServicesController {
	 ...
	 *****************************/
	/*** 리스팅 뷰어 GET ***/
	@RequestMapping(path = "/service-listing", method = RequestMethod.GET)
	public String formServiceList() {
		return "listings-list-full-width.tiles";
	}

	/*** 리스팅 뷰어 POST ***/
	@RequestMapping(path = "/service-listing", method = RequestMethod.POST, produces = {
	...
	public @ResponseBody ResultItems<Services> getAllService(
			...
			@RequestParam(name = "serviceTitle", required = false) String serviceTitle,
			@RequestParam(name = "categorySubject", required = false) String categorySubject) {
		...
		return new ResultItems<Services>(serviceList.stream().collect(Collectors.toList()), page, size,
				serviceList.getTotalElements());
	}

	/*** 리스팅 뷰어 POST - PAGE ***/
	@RequestMapping(path = "/service-listing/{page}", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<Services> changePage(@PathVariable(name = "page", required = false) String pageStr,
			@RequestBody(required = false) QueryServiceModel queryModel,
			@RequestParam(name = "serviceTitle", required = false) String serviceTitle,
			@RequestParam(name = "categorySubject", required = false) String categorySubject) {
		int size = 5;
	...
	@RequestMapping(path = "/service-listing/{serviceId}/view", method = RequestMethod.GET)
	public String singeServicePageForm(@PathVariable(name = "serviceId", required = false) String serviceId) {
		System.out.println("1234124123412341234");
		return "listings-single-page.tiles";
	}

	/*** 싱글 뷰어 POST + PATH(serviceId) ***/
	@RequestMapping(path = "/service-listing/{serviceId}/view", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody SingleServiceModel sendDataToSingleService(@RequestBody RequestModel requestModel,
			@PathVariable(name = "serviceId", required = false) int serviceId) {
	...
	/////////////////////////////////////
	/*** pending page GET ***/
	@RequestMapping(path = "/provider/pending-listing", method = RequestMethod.GET)
	public String providerServiceListFormPending() {
		return "pending-listing.page";
	}

	/*** pending page POST ***/
	@RequestMapping(path = "/provider/pending-listing", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<ServiceTemplate> providerPageableInitServicePending(
		...
		return new ResultItems<ServiceTemplate>(serviceList.stream().collect(Collectors.toList()), page, size,
				serviceList.getTotalElements());
	}

	/*** pending page POST+PATH(page) ***/
	@RequestMapping(path = "/provider/pending-listing/{page}", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<ServiceTemplate> providerPageableServicePending(
			@RequestBody RequestModel requestModel, @PathVariable("page") int page) {
		int size = 5;
	...
	/////////////////////////////////////
	/*** active page GET ***/
	@RequestMapping(path = "/provider/active-listing", method = RequestMethod.GET)
	public String providerServiceListFormActive() {
		return "active-listing.page";
	}

	/*** active page POST ***/
	@RequestMapping(path = "/provider/active-listing", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<Services> providerPageableInitServiceActive(
			@RequestBody RequestModel requestModel) {
		int size = 5, page = 1; // default
		// 정렬 : (기본) 최근 등록순
	...
	@RequestMapping(path = "/provider/active-listing/{page}", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<Services> providerPageableServiceActive(@RequestBody RequestModel requestModel,
	...
	//////////////////////////////////////////
	/*** expired page GET ***/
	@RequestMapping(path = "/provider/expired-listing", method = RequestMethod.GET)
	public String providerServiceListFormExpired() {
		return "expired-listing.page";
	}

	/*** expired page POST ***/
	@RequestMapping(path = "/provider/expired-listing", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<Services> providerPageableInitServiceExpired(
			@RequestBody RequestModel requestModel) {
		int size = 5, page = 1; // default
		// 정렬 : (기본) 최근 등록순
	...
	@RequestMapping(path = "/provider/expired-listing/{page}", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResultItems<Services> providerPageableServiceExpired(@RequestBody RequestModel requestModel,
			@PathVariable("page") int page) {
		int size = 5;
	 ...
	 * [PROVIDER] 서비스 템플릿 등록 *
	 *********************************/
	@RequestMapping(path = "/provider/add-service", method = RequestMethod.GET)
	public String templateForm() {
		return "dashboard-add-listing.page";
	}

	@RequestMapping(path = "/provider/add-service", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	 ...
	 * [PROVIDER] 서비스 실제 등록 *
	 *******************************/
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/regist", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/regist", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	...
	/*** READ ONLY ***/
	@RequestMapping(path = "/provider/my-listing/{serviceId}/read", method = RequestMethod.GET)
	public String serviceViewForm(@PathVariable("serviceId") int serviceId) {
		return "my-listing-edit-readonly.page";
	}

	@RequestMapping(path = "/provider/my-listing/{serviceId}/read", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	...
	/*** UPDATE ***/
	@RequestMapping(path = "/provider/my-listing/{serviceId}/update", method = RequestMethod.GET)
	public String serviceUpdateForm(@PathVariable("serviceId") int serviceId) {
		return "my-listing-edit.page";
	}

	@RequestMapping(path = "/provider/my-listing/{serviceId}/update", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody Services viewExistRegistServiceForUpdate(@PathVariable("serviceId") int serviceId) {
		return listingService.selectOneService(new Long(serviceId));
	}

	@RequestMapping(path = "/provider/my-listing/{serviceId}/update", method = RequestMethod.PUT, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResponseModel updateExistRegistService(@RequestBody PostServiceModel model,
	...
	/*** READ ONLY ***/
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/read", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/read", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	...
	/*** UPDATE ***/
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/update", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/update", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ServiceTemplate showExistTemplateForUpdate(
			@PathVariable("serviceTemplateId") int serviceTemplateId) {
		return templateService.selectOne(new Long(serviceTemplateId));
	}

	@RequestMapping(path = "/provider/my-template/{serviceTemplateId}/update", method = RequestMethod.PUT, produces = {
			MediaType.APPLICATION_JSON_UTF8_VALUE, MediaType.APPLICATION_ATOM_XML_VALUE })
	public @ResponseBody ResponseModel updateExistTemplate(@PathVariable("serviceTemplateId") int serviceTemplateId,
			@RequestBody CreateTemplateModel model, Principal principal) {
